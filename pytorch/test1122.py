...
MUSICPATH = os.path.join(CurrentPath, 'Too Bad.mp3')
...
def main():
        ...
        pygame.display.set_caption('FROM xxx')
                ...
                if mouse_pos[0] < unlike_pos_x+unlike_pos_width+5 and mouse_pos[0] > unlike_pos_x-5 and\
                        ...
                        while True:
                                ...
                                if mouse_pos[0] < unlike_pos_x+unlike_pos_width+5 and mouse_pos[0] > unlike_pos_x-5 and\
                                        ...
                                        continue
                                break
                title('新垣结衣', screen, scale=[3, 8])
                title('牛逼', screen, scale=[3, 4])
                button('同意', like_pos_x, like_pos_y, like_pos_width, like_pos_height, like_color, screen)
                button('不同意', unlike_pos_x, unlike_pos_y, unlike_pos_width, unlike_pos_height, unlike_color, screen)
                pygame.display.flip()
                pygame.display.update()
                clock.tick(60)
        show_like_interface('哈哈哈哈哈哈哈哈哈~', screen, color=(255, 0, 0))
