...
def weight_variable(shape):
    iniial = tf.truncated_normal(shape, stddev=0.1)
    return tf.Variable(iniial)
...
# 去除线性关系
h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)  # output size 28 x 28 x 64
h_pool1 = max_pool_2x2(h_conv1)     # output size 7 x 7 x 64
...
h_pool2 = max_pool_2x2(h_conv2)     # output size 14 x 14 x 32
# func1 layer
